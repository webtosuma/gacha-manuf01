        ...
        <section class="row gy-5 justify-content-center">
            <div class="col-12">
                <div class="rounded-4 bg-white p-3 py-5">
                    ...
                    <h5 class="fw-bold fs-2 text-danger mb-4 text-center border-bottom border-danger border-2 pb-2"
                    >月額 3,000円(税込)プラン</h5>
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        <div class="">
                            ...
                            <div class="fs- mb-3">
                                <i class="bi bi-check-circle-fill text-danger me-1 fs-3"></i>
                                <span class="fs-3 text-danger">3,500pt</span>
                                使い放題（500ptお得！）
                            </div>
                            <div class="fs- mb-3">
                                <i class="bi bi-check-circle-fill text-danger me-1 fs-3"></i>
                                <span class="fs-3 text-danger">チケット40枚</span>
                                付与（10枚お得！）
                            </div>
                            <div class="fs- mb-3">
                                <i class="bi bi-check-circle-fill text-danger me-1 fs-3"></i>
                                <span class="fs-3 text-danger">限定ガチャ</span>
                                解禁！
