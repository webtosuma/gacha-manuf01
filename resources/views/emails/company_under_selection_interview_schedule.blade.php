<!DOCTYPE html>
    ...
    <body>
        ...
        <div class="mail-container border-bottom">
            <!--Title-->
            <h3 class="">面接日程が届きました。</h3>
        </div>
        <div class="mail-container border-bottom">
            {{$company_user->company->name}}から面接日程が届きました。<br>
            <br>
        ...
        <div class="mail-container border-bottom">
            ...
            <div class="bg-light-primary">
                ...
                @php $carbon =\Carbon\Carbon::parse( $scout_selection->interview_datetime ); @endphp
                <span>{{ $carbon->format('Y年m月d日').$weeks[ $carbon->format('w') ].$carbon->format('H時i分') }}</span>
            </div>
            <br><br>


            <strong>面接会場</strong>
            <div class="bg-light-primary">{{ $scout_selection->interview_place }}</div>
            <br><br>


            <strong>採用担当者からのメッセージ</strong>
            <div class="bg-light-primary">{!! nl2br( e( $scout_selection->company_user_message_text ) ) !!}</div>
            <br><br>
        </div>
        <!--求人情報-->
        <div class="mail-container border-bottom">
