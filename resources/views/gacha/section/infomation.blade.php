    ...
    <div class="container py-5">
        <div class="col-md-8 mx-auto">
            <div class="list-group list-group-flush shadow- rounded-0">
                <div class="list-group-item border-0" style="background:rgb(0, 0, 0, .0;">
                    <h3 class="text-center text-whiteee my-3 fw-bold mb-4 fs-2 border-bottom border-light border-2 pb-3"
                    >お知らせ</h3>
                </div>

                @forelse ($infomations as $infomation)
                    <div class="list-group-item list-group-item-actionnn border-0 pozition-relative" style="background:rgb(0, 0, 0, .0;">
                ...
                @empty
                    <div class="list-group-item border-0 pozition-relative" style="background:rgb(0, 0, 0, .0;">
                        <div class="">
                            * お知らせはありません
                        </div>
                    </div>
                ...
                <div class="list-group-item border-0 text-end" style="background:rgb(0, 0, 0, .0;">
