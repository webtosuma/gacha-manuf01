    ...
    @if ( env('NEW_TICKET_SISTEM',false) )
        ...
        <section  class="bg-body border-top" >
            <div class="container">
                <div class="row">
                    <div class="col p-0">
                        <a href="{{ route('ticket_store') }}" class="btn rounded-0 w-100 border-start" >
                    ...
                    <div class="col p-0">
                        <a href="{{ route('infomation') }}" class="btn rounded-0 w-100 border-start" style="font-size:11px;">
                    ...
                    <div class="col p-0">
                        <a href="{{ route('timeline') }}" class="btn rounded-0 w-100 border-start border-end" style="font-size:11px;">
                            <img src="{{asset('storage/site/image/x-logo/logo-black.png')}}"
                            alt="タイムライン" class="d-block mx-auto" style=" width:20px; height:20px;">
                            <div class="text-secondary mt-2" style="font-size:10px; line-height:18px;">タイムライン</div>
                        </a>
                    </div>
                </div>
            </div>
