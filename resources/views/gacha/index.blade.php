                ...
                <div class="row">
                    <div class="col p-0">
                        <a href="{{ route('ticket_store') }}" class="btn py-1 rounded-0 w-100 border-start" >
                            ...
                            <div class="text-secondary mt-1" style="font-size:8px; line-height:11px;">商品と交換</div>
                        </a>
                    </div>
                    <div class="col p-0">
                        <a href="{{ route('infomation') }}" class="btn py-1 rounded-0 w-100 border-start">
                            ...
                            <div class="text-secondary mt-1" style="font-size:8px; line-height:11px;">お知らせ</div>
                        </a>
                    </div>
                    <div class="col p-0">
                        <a href="{{ route('timeline') }}" class="btn py-1 rounded-0 w-100 border-start border-end">
                            ...
                            <div class="text-secondary mt-1" style="font-size:8px; line-height:11px;">タイムライン</div>
                        </a>
                    </div>
                </div>
            </div>
