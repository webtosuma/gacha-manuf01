...
<div class="bg-white border- p-3">
    ...
    <div class="row g-2">
        <div class="col-3">
            <a href="{{ route('mypage') }}" class="btn rounded-3 text-dark shadow-sm fw-bold p-2 w-100" >
        ...
        <div class="col-3">
            <a href="{{ route('guide') }}" class="btn rounded-3 text-dark shadow-sm fw-bold p-2 w-100" style="font-size:11px;">
    ...
    <div class="row g-2">
        ...
        <div class="col-3">
            <a href="{{ route('point_history') }}" class="btn rounded-3 text-primary shadow-sm fw-bold p-2 w-100" style="font-size:11px;">
                ...
                alt="ポイント" class="d-block mx-auto" style=" width:32px; height:32px;">
