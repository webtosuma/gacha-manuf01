@php
    $active_class = "text-info fw-bold border-end border-bottom border-start border-top border-info border-2 bg-white active_menu disabled";
...
<div class="d-flex flex-column justify-content-between py-3 px-2">
    <div class="border-bottom bg-" id="sideMenuAccordion">
        ...
        @foreach ($menu_array as $menu)
            @php
            $icon_class = $menu['icon']." text-info bi fs-4";
