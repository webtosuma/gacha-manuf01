...
@section('title',$gacha_title->name.'タイトル商品 新規登録')
...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ 'タイトル商品 新規登録' }}</li>
        </ol>
    </nav>


    <h5 class="fw-bold">タイトル商品 新規登録</h5>


    <section class="container">

        <form action="{{ route('admin.gacha_title.title_prize.store',$gacha_title) }}" method="POST"
        novalidate
