...
<body class="">
    <div id="app">
        ...
        <!--header-->
        <div class="d-lg-none">
            @include('manuf_admin.includes.gacha_header')
        </div>
        ...
        <main class="row mx-0 g-0">
            ...
            <aside class="d-none d-lg-block col-auto pe-0 bg-body">
                <div class="position-sticky ps-2" style="top: 0rem; ">
                    ...
                    <div class="my-3 text-center">
                        <a href="{{route('admin.gacha')}}" class="btn btn-sm btn-light border ">< タイトル一覧に戻る</a>
                    </div>

                    @include('manuf_admin.includes.gacha_side_menu')
            ...
            <div class="col bg-white">
                ...
                <div class="border-bottom">
                    <h2 class="container fs-5 my-2">ガチャタイトル</h2>
                </div>
