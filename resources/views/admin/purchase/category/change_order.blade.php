...
@section('content')
    <div class="container mb-4">
        ...
        <h2 class="mb- py-3 border-bottom">{{ '買取カテゴリー　並び替え' }}</h2>
        ...
        <section class="col-md-8 mx-auto">
            <form action="{{ route('admin.purchase.category.change_order.update',) }}" method="POST"
            enctype="multipart/form-data" onsubmit="stopOnbeforeunload()">
                ...
                token="{{ csrf_token() }}"
                r_api_list="{{route('admin.api.purchase.category')}}"
                ></a-category-change-order>
