...
@section('content')
    <div class="container mb-4">
        ...
        <section class="mb-3">
            <form action="{{route('admin.gacha')}}" method="GET">


                <div class="row g-1 align-items-end">
                    <!--カテゴリー選択-->
                    <div class="col-12 col-md">
                        <div class="fw-bold">カテゴリー選択</div>
                        <select class="form-select" name="category_code">
                            <option value="">すべて</option>

                            @foreach ($categories as $category)
                                <option value="{{$category->code_name}}">{{ $category->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <!--タイトル検索-->
                    <div class="col">
                        <div class="fw-bold">タイトル検索</div>
                    ...
                    <!--絞り込みボタン-->
                    <div class="col-auto">
                        <button class="btn btn-dark border" type="submit">検索</button>
                    </div>
