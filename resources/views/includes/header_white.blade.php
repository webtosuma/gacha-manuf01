        ...
        <nav class="d-flex justify-content-between align-items-center">
            ...
            <h1 class="d-flex align-items-center gap-3 m-0 ms-3">
                <a class="navbar-brand" href="{{ url('/') }}" style="shad">
                    ...
                    alt="{{ config('app.name') }}" class="d-brock" style="height:4.4rem;">
                </a>
            </h1>
            ...
            <div class="d-flex align-items-center ">
                ...
                @guest
                    <!-- ログイン前 -->
                    {{-- <a class="btn btn-sm btn-dark text-whiteee rounded-pill shadow-sm fw-bold border-warning border-3 me-2"
                    href="{{ route('register') }}">{{ __('会員登録') }}</a>
                    --}}
                    <a class="btn btn-sm rounded- border fw-bold me-2 text-whiteee"
                ...
                @else
                    ...
                    <!-- ハンバーガーボタン -->
                    <button class="btn bg- px-2 py-0 ms-2 text-whiteee rounded-0" type="button"
