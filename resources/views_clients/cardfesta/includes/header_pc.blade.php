...
<header class="position-fixed w-100 pt-" style="z-index:100;">
    ...
    <div class="container py-2 px-0 position-relative">
        ...
        <!-- rogo -->
        <h1 class="position-absolute top-50 start-50 translate-middle bg-white px-4 rounded-pill border border-primary border-3">
            <a class="navbar-brand" href="{{ url('/') }}">
                <img src="{{asset('storage/site/image/logo.png')}}"
                alt="{{ config('app.name') }}" class="d-brock" style="height:3.2rem;">
            </a>
        </h1>

        @php $rogo_height = 51.2; $rogo_border_height = $rogo_height + 8; @endphp
        ...
        {{-- <nav class="d-flex justify-content-between align-items-center ps-3 mx-1 "> --}}
        ...
        rounded-pill ps-3 mx-1 shadow" style="background:rgb(255, 255, 255, .9);">
            ...
            <div class="col">
                <div class="row align-items-center" style="width:12rem;">
                    <div class="col p-0">
