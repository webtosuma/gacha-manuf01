<div class="offcanvas offcanvas-end bg-dark" tabindex="-1" id="offcanvasHumberge" aria-labelledby="offcanvasHumbergeLabel"
style="max-width:90vw; min-width:30vw;">
    ...
    <div class="offcanvas-header align-items-center border-bottom bg-dark">
        ...
        <!--閉じる-->
        <button type="button" class="btn btn-outline-light" data-bs-dismiss="offcanvas" aria-label="Close">
    ...
    <div class="offcanvas-body px-0 pt-0">
        ...
        @else
            <div class="d-flex justify-content-between align-items-center p-3 bg-white text-dark">
                <div class="col">
        ...
        <div class="list-group list-group-flush bg-dark">
            ...
            d-block bg-dark text-white mt-3 border- pt-2">
            ...
            <a href="{{ route('gacha_history') }}" class="d-block bg-dark text-white list-group-item list-group-item-action py-3 px-5 position-relative"
            >ガチャ履歴
            ...
            <a href="{{ route('point_history') }}" class="d-block bg-dark text-white list-group-item list-group-item-action py-3 px-5 position-relative"
            >ポイント履歴
            ...
            <a href="{{ route('shipped') }}" class="d-block bg-dark text-white list-group-item list-group-item-action py-3 px-5 position-relative">
                発送履歴
            ...
            <a href="{{ route('settings') }}" class="d-block bg-dark text-white list-group-item list-group-item-action py-3 px-5 position-relative"
            >会員情報設定
            ...
            <a href="{{ route('guide') }}" class="d-block bg-dark text-white list-group-item list-group-item-action py-3 px-5 position-relative"
            >利用ガイド
            ...
            <a href="{{ route('infomation') }}" class="d-block bg-dark text-white list-group-item list-group-item-action py-3 px-5 position-relative"
            >お知らせ
            ...
            class="d-block bg-dark text-white list-group-item list-group-item-action py-3 px-5 position-relative">
            ...
            @if ( Auth::check() )
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <button class="d-block bg-dark text-white list-group-item list-group-item-action py-3 px-5 position-relative"
