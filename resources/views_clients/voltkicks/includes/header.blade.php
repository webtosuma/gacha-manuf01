<header class="position-fixed bg- w-100" style="z-index:100; background:rgb(0, 0, 0,0);">
    @if ( config('app.debug') )
        ...
        <nav class="d-flex justify-content-between align-items-center">
            ...
            <h1 class="d-flex align-items-center gap-3 m-0 ms-3">
                <a class="navbar-brand" href="{{ route('gacha_category') }}" style="shad">
                    ...
                    alt="{{ config('app.name') }}" class="d-brock my-2" style="height:4.0rem;">
                </a>
            </h1>
            ...
            <div class="d-flex align-items-center ">
                ...
                @guest
                    ...
                    --}}
                    <a class="btn btn-sm rounded- border fw-bold me-2 text-white"
                ...
                @else
                    ...
                    <!-- ハンバーガーボタン -->
                    <button class="btn bg- px-2 py-0 ms-2 text-white rounded-0" type="button"
