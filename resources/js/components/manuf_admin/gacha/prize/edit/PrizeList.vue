<template>
    <div>
        ...
        <div class="">
            ...
            data-bs-toggle="modal" :data-bs-target="'#'+'addPrize'+gacha_rank_id"
            ><i class="bi bi-plus-lg"></i>追加</button>

            <!-- Modal -->
            <div class="modal fade" :id="'addPrize'+gacha_rank_id" 
            data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" 
            :aria-labelledby="'addPrize'+gacha_rank_id+'Label'" aria-hidden="true">
                ...
                <div class="modal-dialog modal-dialog-scrollable" style="max-width:900px;">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            :id="'addPrize'+gacha_rank_id+'Label'"
                            >{{rank_label}}</h1>
...
<script>
    ...
    export default {
        props: {
            ...
            rank_label:    { type: [String,Number],  default: '', },
