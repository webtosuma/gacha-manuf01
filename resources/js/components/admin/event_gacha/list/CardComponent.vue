<template>
    <div>
        <div :class="card_style_class">
            ...
            <!--image-->
            <a :href="gacha.r_event_show"  :class="href_class"  style="opacity:1 !important;">
            ...
            <!-- 説明文 -->
            <a :href="gacha.r_event_show"  :class="href_class" class="p-2">
                <div class="d-flex justify-content-center" style="min-height:6rem;">
                ...
                <div class="text-end text-info">
                    詳しく見る<i class="bi bi-chevron-double-right"></i>
                </div>
            </a>
            ...
            <!--metter & price-->
            <!-- <a :href="gacha.r_event_show"  :class="href_class">
