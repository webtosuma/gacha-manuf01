    ...
    <div class="mx-auto overflow-hidden" style="height:100vh; max-width:100vw;">
        ...
        <div class="d-flex align-items-center h-100 w-100">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <!-- 音声切り替えボタン -->
                <button @click="switchMuted" class="btn btn-light btn-sm py-0 fs-3" id="muteButton">
                ...
                <button v-if="time==0" type="submit" class="btn btn-light btn-sm py-0">
