...
class GachaPrizeSeeder extends Seeder
{
    ...
    {
        $data_array = [
            // ['rank'=>'a',  'count'=>1, 'rank_id'=>'3', 'gacha_rank_id'=>'300', 'max_count'=>11,],
            ...
            // ['rank'=>'b',  'count'=>5, 'rank_id'=>'4', 'gacha_rank_id'=>'400', 'max_count'=>45,],
            // ['rank'=>'c',  'count'=>7, 'rank_id'=>'5', 'gacha_rank_id'=>'500', 'max_count'=>50,],
            // ['rank'=>'d',  'count'=>1, 'rank_id'=>'6', 'gacha_rank_id'=>'600', 'max_count'=>1,],

            // ['rank'=>'キリ番',    'count'=>1, 'rank_id'=>'2', 'gacha_rank_id'=>'310', 'max_count'=>2,],
            // ['rank'=>'ゾロ目',    'count'=>1, 'rank_id'=>'2', 'gacha_rank_id'=>'320', 'max_count'=>2,],
            // ['rank'=>'ラストワン', 'count'=>1, 'rank_id'=>'1', 'gacha_rank_id'=>'10', 'max_count'=>1,],
        ];
